...
\begin{frame}
	...
	\only<1>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd0}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree0}}
			}
	\end{figure}
	}
	\only<2>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd1}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree1}}
			}
	\end{figure}
	}
	\only<3>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd2}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree2}}
			}
	\end{figure}
	}
	\only<4>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd3}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree3}}
			}
	\end{figure}
	}
	\only<5>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd4}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree4}}
			}
	\end{figure}
	}
	\only<6>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd5}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree5}}
			}
	\end{figure}
	}
	\only<7>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd6}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree6}}
			}
	\end{figure}
	}
	\only<8>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd7}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree7}}
			}
	\end{figure}
	}
	\only<9>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd8}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree8}}
			}
	\end{figure}
	}
	\only<10>{
		\begin{figure}
		\mbox{
			\subfigure{\includegraphics[width=.45\linewidth]{bilder/kd9}}\quad
			\subfigure{\includegraphics[width=.5\linewidth]{bilder/kdtree9}}
			}
	\end{figure}
	}
...
\begin{frame}
	...
	\Else
		...
		\EndIf
		\pause
		\If {$region(rc(v))\mbox{ ist vollständig in }R$}
			\State $MeldeTeilbaum(rc(v))$
		\Else
			\If{$region(rc(v)) \mbox{ überschneidet sich mit } R$}
